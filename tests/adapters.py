...
from cs336_basics.optimizer import AdamW, avg_cross_entropy, cosine_lr_schedule, grad_clipping
...
def run_rope(
    ...
    """
    layer = RoPE(theta, d_k, max_seq_len, device=in_query_or_key.device)
